...
localStorage.setItem('FR ProjectType', ProjectType);

var Executed = document.getElementById("uid-ctrl-17").value;
localStorage.setItem('FR Executed', Executed);

var URL = window.location.href;
localStorage.setItem('FR URL', URL);
